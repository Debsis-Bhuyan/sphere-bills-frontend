...
const CreateEstimateBills = () => {
  const user = useSelector((state) => state.user).user.user;

  const location = useLocation();
  const data = location.state;
  const [purchaseDetails, setPurchaseDetails] = useState(data.purchaseItemData);
    ...
    <div className="px-8 py-2 bg-white shadow-lg rounded-lg  mx-auto">
      ...
      <div className="flex justify-between border-b border-gray-300 pb-4 mb-6">
        ...
        <div className="text-gray-700">
          ...
          <p>Estimate Number: {partyData?.number}</p>
        </div>
      </div>
...
export default CreateEstimateBills;
